...
async function main() {
  ...
  console.log(`Seed success: ${mockEmps.length} employees created.`);
  ...
  console.log('Seed success: FormTemplate created.');
  ...
  console.log('Seed success: Campaigns and Evaluations created.');
  ...
  console.log('Seed success: CompCampaign created.');
  ...
  const regulars = allEmps.filter(e => e.role === 'EMPLOYEE').slice(0, 3);
  ...
  console.log('Seed success: Expenses created.');
